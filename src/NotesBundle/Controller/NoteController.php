...
class NoteController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('@Almni/Admin/note/index.html.twig', array(
            'notes' => $notes,
        ));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        return $this->render('@Almni/Admin/note/new.html.twig', array(
            'note' => $note,
    ...
    public function showAction(Note $note)
    {
        ...
        return $this->render('@Almni/Admin/note/show.html.twig', array(
            'note' => $note,
    ...
    public function editAction(Request $request, Note $note)
    {
        ...
        return $this->render('@Almni/Admin/note/edit.html.twig', array(
            'note' => $note,
